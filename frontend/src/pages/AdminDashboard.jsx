      ...
      <div className="overflow-x-auto mb-8 -mx-1 px-1">
        <div className="flex gap-1 bg-slate-100 rounded-xl p-1 w-fit min-w-full sm:min-w-0">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 text-sm font-medium rounded-lg transition-all whitespace-nowrap ${activeTab === 'products'
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 text-sm font-medium rounded-lg transition-all whitespace-nowrap ${activeTab === 'orders'
                ? 'bg-white text-slate-900 shadow-sm'
                : 'text-slate-500 hover:text-slate-700'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 text-sm font-medium rounded-lg transition-all whitespace-nowrap ${activeTab === 'statistics'
                ? 'bg-white text-slate-900 shadow-sm'
                : 'text-slate-500 hover:text-slate-700'
              }`}
          >
                  ...
                  >
                    <div className="mb-4">
                      <div className="flex flex-wrap items-start justify-between gap-3">
                        ...
                        <span className="text-lg font-bold text-slate-900 flex-shrink-0">${order.total.toFixed(2)}</span>
                      </div>
                      ...
                      {order.status === 'pending' && (
                        <div className="flex flex-wrap gap-2 mt-3">
                          <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-2 bg-green-600 text-white text-xs font-semibold rounded-lg hover:bg-green-700 transition-all"
                          >
                          ...
                          <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-2 bg-red-500 text-white text-xs font-semibold rounded-lg hover:bg-red-600 transition-all"
                          >
